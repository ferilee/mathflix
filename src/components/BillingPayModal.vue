<template>
    ...
    >
        ...
        <div
            class="relative w-[92%] max-w-3xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 p-6"
        >
            <div class="flex items-start justify-between gap-4">
                <div>
                    ...
                    >
                        Pembayaran Akses Siswa
                    </h3>
                    <p class="text-sm text-slate-500 dark:text-slate-400">
                        Pilih siswa yang ingin diaktifkan aksesnya.
                    </p>
                </div>
                <button
                    type="button"
            ...
            <div class="mt-3 text-xs text-slate-500 dark:text-slate-400">
                1 kelas = grade - jurusan - kelas. Total kelas ditagihkan
                dihitung otomatis.
            </div>
            ...
            <div
                class="mt-4 max-h-[320px] overflow-auto border border-slate-200 dark:border-slate-700 rounded-xl"
            >
                <div
...
const totalAmount = computed(() => {
    return props.selectedClassCount * props.pricePerClass;
});
