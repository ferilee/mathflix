<template>
  <div>
    <h1 class="text-3xl font-bold mb-6">Jurnal Refleksi Siswa</h1>
    ...
    <div v-else>
        <div class="space-y-4">
             ...
             <div v-for="ref in reflections" :key="ref.id" class="bg-white p-4 rounded shadow border">
                 <div class="flex justify-between items-start mb-2">
                     <div class="flex items-center gap-2">
                         <span class="font-bold text-gray-800">{{ ref.student.full_name }}</span>
                         <span class="text-xs text-gray-500">({{ ref.student.grade_level }} {{ ref.student.major }})</span>
                         <span class="text-xs bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded ml-2">{{ ref.topic || 'General' }}</span>
                     </div>
                 ...
                 <p class="text-gray-700 whitespace-pre-line mb-3 bg-gray-50 p-3 rounded italic">"{{ ref.content }}"</p>
